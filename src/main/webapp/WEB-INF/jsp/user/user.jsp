		...
		<div class="row">
			...
			<div class="table-responsive">
				<form class="form-horizontal" role="form"
					action="${ctx}/user/selectUser" method="post">
					...
					<div class="form-group">
						...
						<div class="col-xs-3">
							<input type="text" class="form-control" id="status" name="status"
								placeholder="请输入姓" value="${requestScope.user.status }">
						</div>
					</div>
					<div class="form-group">
				...
				<table class="center">
					...
					<tr valign="top">
						<td align="center" class="font3"><fkjava:pager
								...
								submitUrl="${ctx}/user/selectUser?pageIndex={0}&username=${requestScope.user.username}&status=${requestScope.user.status}" />
						</td>
					</tr>
				</table>
			</div>
